...
export default function UserBlogPage({ params }: { params: Promise<{ username: string }> }) {
    const { username } = use(params);
    const { data, error, isLoading } = useSWR<BlogData>(
    ...
    return (
      <section className="px-4 py-12">
        <div className="mx-auto max-w-5xl">
          <div className="grid place-items-center min-h-[50vh]">
            <div className="text-center">
              <h1 className="text-lg font-semibold text-white">Error loading posts</h1>
              ...
              <li key={post.id}>
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    {post.desc && (
                      <p className="mt-1 line-clamp-3 text-sm text-zinc-400">{post.desc}</p>
                    )}
